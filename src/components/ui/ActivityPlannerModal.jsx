              ...
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-white/70">
                    {currentFlow ? 'Choose your planning approach' : 'What would you like to plan today?'}
                  </p>
                </div>
                <button
                  onClick={handleClose}
                ...
                <AnimatePresence mode="wait">
                  {currentFlow === 'singleActivity' && (
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <SingleActivityPlanner onClose={handleClose} />
                    </motion.div>
                  )}
                  ...
                  {currentFlow === 'manualPoll' && (
                    <motion.div
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <ManualPollCreator onClose={handleClose} />
                    </motion.div>
                  )}
                </AnimatePresence>
              )}
