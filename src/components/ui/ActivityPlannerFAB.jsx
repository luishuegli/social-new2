  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-accent-primary rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center"
      >
